...
if widthI > heightI or widthI == heightI:
    while widthI > 800:
        widthI /= 2
        heightI /= 2
...
widthI = int(widthI)
heightI = int(heightI)
pic = pic.resize((widthI, heightI))
photoShopImage = photoShopImage.resize((widthI, heightI))

photo = ImageTk.PhotoImage(pic)  # Uses a function in the Image library ImageTk to make it compatible with Tkinter
root.geometry(str(widthI + 60) + 'x' + str(heightI + 60) + '+30+30')  # This sets the screen widthxheight+sidePadding+sidePadding
